 ...
 *         &lt;element name="Data" type="{http://ifrs15.vodafone.com/events/billrunreconciliation_v1}billRunReconciliationsComplexType"/&gt;
...
@XmlRootElement(name = "BillRunReconciliations")
public class BillRunReconciliations {

    @XmlElement(name = "Header", required = true)
    protected FileHeaderComplexType header;
    @XmlElement(name = "Data", required = true)
    protected BillRunReconciliationsComplexType data;
     ...
     * @return
     *     possible object is
     *     {@link BillRunReconciliationsComplexType }
     *     
     */
    public BillRunReconciliationsComplexType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(BillRunReconciliationsComplexType value) {
        this.data = value;
    }
