 ...
 *         &lt;element name="sAPRARFundID" type="{http://ifrs.vodafone.com/commonTypes_v1}sAPRARFundIDType"/&gt;
...
public class FundComplexType {
    ...
    @XmlElement(name = "sAPRARFundID", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String saprarFundID;
    ...
    /**
     * Obtiene el valor de la propiedad saprarFundID.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSAPRARFundID() {
        return saprarFundID;
    }

    /**
     * Define el valor de la propiedad saprarFundID.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSAPRARFundID(String value) {
        this.saprarFundID = value;
    }
