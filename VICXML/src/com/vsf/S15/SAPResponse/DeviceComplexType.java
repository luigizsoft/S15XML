 ...
 *       &lt;sequence&gt;
 *         &lt;element name="deviceID" type="{http://ifrs.vodafone.com/commonTypes_v1}serviceIDType"/&gt;
 *         &lt;element name="sAPRARDeviceID" type="{http://ifrs.vodafone.com/commonTypes_v1}sAPRARDeviceIDType"/&gt;
...
public class DeviceComplexType {
    ...
    @XmlElement(name = "sAPRARDeviceID", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String saprarDeviceID;
    ...
    /**
     * Obtiene el valor de la propiedad saprarDeviceID.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSAPRARDeviceID() {
        return saprarDeviceID;
    }

    /**
     * Define el valor de la propiedad saprarDeviceID.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSAPRARDeviceID(String value) {
        this.saprarDeviceID = value;
    }
