 ...
 *         &lt;element name="sAPRARMaterialRightID" type="{http://ifrs.vodafone.com/commonTypes_v1}sAPRARMaterialRightIDType"/&gt;
...
public class MaterialRightsComplexType {
    ...
    @XmlElement(name = "sAPRARMaterialRightID", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String saprarMaterialRightID;
    ...
    /**
     * Obtiene el valor de la propiedad saprarMaterialRightID.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSAPRARMaterialRightID() {
        return saprarMaterialRightID;
    }

    /**
     * Define el valor de la propiedad saprarMaterialRightID.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSAPRARMaterialRightID(String value) {
        this.saprarMaterialRightID = value;
    }
