 ...
 *         &lt;element name="sAPRARLeasingID" type="{http://ifrs.vodafone.com/commonTypes_v1}sAPRARLeasingIDType"/&gt;
...
public class LeasingComplexType {
    ...
    @XmlElement(name = "sAPRARLeasingID", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String saprarLeasingID;
    ...
    /**
     * Obtiene el valor de la propiedad saprarLeasingID.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSAPRARLeasingID() {
        return saprarLeasingID;
    }

    /**
     * Define el valor de la propiedad saprarLeasingID.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSAPRARLeasingID(String value) {
        this.saprarLeasingID = value;
    }
