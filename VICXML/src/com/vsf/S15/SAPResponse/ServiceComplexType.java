 ...
 *         &lt;element name="sAPRARServiceID" type="{http://ifrs.vodafone.com/commonTypes_v1}sAPRARServiceIDType"/&gt;
...
public class ServiceComplexType {
    ...
    @XmlElement(name = "sAPRARServiceID", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String saprarServiceID;
    ...
    /**
     * Obtiene el valor de la propiedad saprarServiceID.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSAPRARServiceID() {
        return saprarServiceID;
    }

    /**
     * Define el valor de la propiedad saprarServiceID.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSAPRARServiceID(String value) {
        this.saprarServiceID = value;
    }
