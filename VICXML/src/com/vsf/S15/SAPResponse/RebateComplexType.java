 ...
 *         &lt;element name="sAPRARRebateID" type="{http://ifrs.vodafone.com/commonTypes_v1}sAPRARRebateIDType"/&gt;
...
public class RebateComplexType {
    ...
    @XmlElement(name = "sAPRARRebateID", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String saprarRebateID;
    ...
    /**
     * Obtiene el valor de la propiedad saprarRebateID.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSAPRARRebateID() {
        return saprarRebateID;
    }

    /**
     * Define el valor de la propiedad saprarRebateID.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSAPRARRebateID(String value) {
        this.saprarRebateID = value;
    }
