 ...
 *         &lt;element name="deviceQuantity" type="{http://ifrs.vodafone.com/commonTypes_v1}deviceIDType"/&gt;
...
public class DeviceComplexType {
    ...
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String deviceQuantity;
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     *     
     */
    public void setDeviceQuantity(String value) {
