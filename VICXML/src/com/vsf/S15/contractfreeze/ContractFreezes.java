 ...
 *         &lt;element name="Data" type="{http://ifrs15.vodafone.com/events/contractfreeze_v1}contractfreezesComplexType"/&gt;
...
@XmlRootElement(name = "ContractFreezes")
public class ContractFreezes {

    @XmlElement(name = "Header", required = true)
    protected FileHeaderComplexType header;
    @XmlElement(name = "Data", required = true)
    protected ContractfreezesComplexType data;
     ...
     * @return
     *     possible object is
     *     {@link ContractfreezesComplexType }
     *     
     */
    public ContractfreezesComplexType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(ContractfreezesComplexType value) {
        this.data = value;
    }
